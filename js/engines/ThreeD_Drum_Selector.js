 ...
 * EXACT merged copy of BOTH ThreeD_component_engine and TextGeometryDrumEngine
 */
...
// First, the complete ThreeD_component_engine code renamed to ThreeD_Drum_Selector_Base
class ThreeD_Drum_Selector_Base {
...
// Now the TextGeometryDrumEngine code that extends it
/**
...
// import removed from './3_D_component_engine.js';

export class ThreeD_Drum_Selector extends ThreeD_Drum_Selector_Base {
    constructor(container, config = {}) {
