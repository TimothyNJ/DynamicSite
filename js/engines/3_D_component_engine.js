...
export class ThreeD_component_engine {
    ...
    init() {
        ...
        // Temporarily disabled to test with equal starting conditions
    ...
    setupRenderer() {
        ...
        // Let canvas use its natural size for proper container fitting
        // Canvas dimensions are set by renderer.setSize() above
