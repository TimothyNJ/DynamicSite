 ...
 *
 * Created: 17-Apr-2026
 * Updated: 18-Apr-2026 — concurrency test 3
 */
...
// CI concurrency control only cancels in-flight builds — sequential deploys
// (push, wait, push again) still each produce a new version.json, so the
// cooldown is needed even with concurrency control in place.
