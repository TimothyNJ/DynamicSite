...
class ComponentFactory {
   ...
   * Uses drum_wheel_3d_component_engine which is a copy of 3D engine
   * with rotation constrained to X-axis only
   * @param {string} containerId - ID of the container element
  ...
  createDrumWheel3D(containerId, config = {}) {
    ...
    // Create drum wheel instance (currently identical to 3D engine)
